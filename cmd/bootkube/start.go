...
func init() {
	...
	cmdStart.Flags().StringSliceVar(&startOpts.requiredPods, "required-pods", []string{}, "List of pods with their namespace (written as <namespace>/<pod-name>) that are required to be running and ready before the start command does the pivot.")
}
